...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@circuitcoder/PaperDye";
  public static final String SHELL_APP_SCHEME = "exp5cbedf2ff959481c82341b6a1e79fbdd";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@circuitcoder/PaperDye", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40circuitcoder%2FPaperDye%2F1.0.0%2F7e53d7230587f3a9fa4be3e01ed5c850-34.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
